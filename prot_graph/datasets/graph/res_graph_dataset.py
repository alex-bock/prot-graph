...
from ..structure.struct_dataset import StructDataset
...
class ResGraphDataset(TorchDataset):
    ...
    def _build_graphs(
        ...
        graphs = process_map(
            ...
            struct_dataset.ids, chunksize=1
        )
    ...
    def train(self) -> List[Data]:
        ...
        return [
            self[i] for i, g in enumerate(self.graphs)
            if g.id in self.splits["train"]
        ]
